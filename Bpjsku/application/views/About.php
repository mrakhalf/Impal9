...
<body class="single-page">
  <header class="site-header">
      ...
      <img class="header-img" src="<?php echo base_url("assets/images/about-bg.png") ?>" alt="">
  </header><!-- .site-header -->
        ...
        <div class="container">
            <div class="row align-items-end">
                <div class="col-12 col-lg-6">
                    <h2>BPJSku</h2>
                    <p>BPJSku didirikan pada tahun 2018 tepatnya pada bulan April, BPJSku adalah website penyedia layanan Kesehatan Berupa antrian BPJS, untuk mempermudah dan lebih efektif.</p>
                </div>

                <div class="col-12 col-lg-6 mt-5 mt-lg-0">
                    <img class="responsive" src="<?php echo base_url('assets/images/about.jpg'); ?>" alt="">
                </div>
            </div>
        </div>
    </div>

    <div class="faq-stuff" style="background: url('<?php echo base_url('assets/images/faq-bg.jpg'); ?>'); background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>FAQ</h2>
                ...
                <div class="col-12 col-lg-6 mb-5 mb-lg-0">
                    <div class="accordion-wrap type-accordion">
                        <h3 class="entry-title d-flex justify-content-between align-items-center active">Bagaimana Cara Melakukan Pendaftaran ?<span class="arrow-r"></span></h3>

                        <div class="entry-content">
                            <p>Pengguna hanya perlu kembali ke menu home lalu dibagian pojok kanan terdapat tulisan daftar.</p>
                        </div>

                        <h3 class="entry-title d-flex justify-content-between align-items-center">Bagaimana jika saya mempunyai masalah mengenai aplikasi ? <span class="arrow-r"></span></h3>

                        <div class="entry-content">
                            <p>Anda bisa langsung menghubungi kami di +022 780 1234 untuk lebih lanjutnya.</p>
                        </div>

                        <h3 class="entry-title d-flex justify-content-between align-items-center">Apakah Saya Perlu Login Untuk Melakukan Pendaftaran ?<span class="arrow-r"></span></h3>

                        <div class="entry-content">
                            <p>Iya tentu saja, anda diharuskan untuk login karena pihak kami membutuhkan identitas pengguna.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="professional-box">
                                ...
                                <img src="<?php echo base_url('assets/images/cardiogram-2.png'); ?>" alt="">

                                <p>Tim BPJSku sangat berpengalaman dalam menangani berbagai macam keluhan pelanggan.</p>
                            </div>
                        </div>

                        <div class="col-12 col-md-6">
                            <div class="quality-box">
                                <h2 class="d-flex align-items-center">Kualitas</h2>

                                <img src="<?php echo base_url('assets/images/hospital.png'); ?>" alt="">

                                <p>Kualitas pelayanan BPJSku sangatlah baik, efisien dan sangat mempermudah penggunanya.</p>
                            </div>
                        </div>
                    </div>
                </div>

                ...
                <div class="row">
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        <div class="site-branding d-flex align-items-center">
                           <a class="d-block" href="<?php echo site_url('Home/Admin'); ?>" rel="home"><img class="d-block" src="<?php echo base_url("assets/images/logo.png") ?>" alt="logo"></a>
                        </div><!-- .site-branding -->

                        <nav class="site-navigation d-flex justify-content-end align-items-center">
                            <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-items-center">
                              <li><a href="<?php echo site_url('Home/Admin'); ?>">Home</a></li>
  ...
  <div class="container-login100">
    <div class="wrap-login100">
      <div class="login100-pic js-tilt" data-tilt>
        <img style="border-radius:40%; padding-top:50px;" src="<?php echo base_url('assets/images/admin.png');?>" alt="IMG">
      </div>

      <form class="login100-form role="form" method="POST" action="<?php echo site_url('LoginAdmin/doLogin') ?>" validate-form">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="foot-about">
                        <h2><a href="<?php echo site_url('Home/Admin'); ?>" <?php echo site_url('Home/Admin'); ?>""><img src="<?php echo base_url('assets/images/logo.png'); ?>" alt=""></a></h2>

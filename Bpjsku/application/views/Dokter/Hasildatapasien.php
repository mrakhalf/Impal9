...
<div class="container">
<form action="<?php echo site_url('Hasildatapasien/tambah_aksi') ?>" class="form-horizontal" role="form" method="POST" validate-form>
  <div class="row">
      ...
      <div class="col-md-6">
          <div class="form-group">
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-hospital-o"></i></div>
                  <input type="text" name="rumahsakit" class="form-control" id="name"
                         placeholder="Masukan Rumah Sakit" required autofocus>
              </div>
          </div>
      </div>
      <div class="col-md-3">
  ...
  <div class="row">
      ...
      <div class="col-md-6">
          <div class="form-group">
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-sort-numeric-asc "></i></div>
                  <input type="text" name="nomorantrian" class="form-control" id="name"
                         placeholder="Masukan Nomor Antrian" required autofocus>
              </div>
          </div>
      </div>
      <div class="col-md-3">
      ...
      <div class="col-md-6">
          <div class="form-group">
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  ...
                  <input type="time" name="waktu" class="form-control" id="name"
                         placeholder="Masukan Waktu" required autofocus>
              </div>
          </div>
      </div>
      <div class="col-md-3">
  ...
  <div class="row">
      ...
      <div class="col-md-6">
          <div class="form-group has-danger">
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-heartbeat" aria-hidden="true"></i></div>
                  <input type="text" name="keluhan" class="form-control" id="password"
                  placeholder="Masukan Keluhan" required>
              </div>
          </div>
      </div>
  ...
  <div class="row">
      ...
      <div class="col-md-6">
        <br>
          <button class="button gradient-bg" href="index.html" class="btn"><i aria-hidden="true"></i> Submit</button>
      </div>
  </div>
</form>
</div>

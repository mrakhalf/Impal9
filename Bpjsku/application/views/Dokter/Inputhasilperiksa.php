...
<html lang="en">
<head>
    <title>Input Hasil Periksa</title>
...
<body>
  ...
  <div class="container-login100">
    <div class="container">
  <form class="form-horizontal" role="form" method="POST" action="<?php echo site_url('Inputhasilperiksa/tambah_aksi') ?>" validate-form">
      <div class="row">
          <div class="col-md-2">
      <div class="logoCatalog">
      <img src="<?php echo base_url('assets/images/logo.png'); ?>" width=150px height=150px></img>
      </div>
    </div>
          <div class="col-md-6">
      <div class="juduldaftar">
              <h2 align="center">INPUT HASIL PERIKSA</h2>
              <hr>
      </div>
          </div>
      </div>
          ...
          <div class="col-md-6">
              <div class="form-group">
                  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                      ...
                      <input type="text" name="namapasien" class="form-control" id="name" placeholder="Masukan Nama Pasien" required autofocus>
                  </div>
              </div>
          </div>
          <div class="col-md-3">
      ...
      <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-medkit"></i></div>
                    <input type="text" name="resepobat" class="form-control" id="name" placeholder="Masukan Resep Obat" required autofocus>
                </div>
              </div>
          </div>
      </div>
      ...
      <div class="row">
          <div class="col-md-3 field-label-responsive">
              <label for="hasilperiksa">Hasil Periksa</label>
          </div>
          <div class="col-md-6">
            <div class="form-group">
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-search"></i></div>
                    <input type="text" name="hasilperiksa" class="form-control" id="name" placeholder="Masukan Hasil Periksa" required autofocus>
                </div>
              </div>
              <div class="row">
          <div class="col-md-3">
               <button type="submit" class="button gradient-bg"><i class="fa fa-user-plus"></i> SUBMIT</button>
          </div>
          <div class="col-md-6">
          </div>
          </div>

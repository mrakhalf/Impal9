      ...
      <div id="tab_1" class="tab_container active" >
          ...
          <?php
            foreach($Pasien as $i):
              ?>
              <div class="col-md-12">
                  <a href="<?php echo site_url('Dokter/Hasildatapasien') ?>"><h2 style="font-size:25px;">Nama Pasien : <?php echo $i['namalengkap'] ?></h2></a>
                  <p>Rumah Sakit : RS Muhammadiyah</p>
                  <p>ID Bpjs : <?php echo $i['idbpjs'] ?></p>
              </div>

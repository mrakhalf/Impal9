...
<body>
  ...
  <div class="container-login100">
    ...
    <div class="container">
  <form class="form-horizontal" role="form" method="POST" action="<?php echo site_url('Inputsuratrujuk/tambah_aksi') ?>" validate-form>
      <div class="row">
          <div class="col-md-2">
      <div class="logoCatalog">
      <img src="<?php echo base_url('assets/images/logo.png'); ?>" width=150px height=150px>
      </div>
    </div>
          <div class="col-md-6">
      <div class="juduldaftar">
              <h2 align="center">INPUT SURAT RUJUKAN</h2>
              <hr>
      </div>
          </div>
      </div>
          ...
          <div class="col-md-6">
              <div class="form-group">
                  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                      ...
                      <input type="text" name="namapasien" class="form-control" id="name"
                             placeholder="Masukan Nama Pasien" required autofocus>
                  </div>
              </div>
          </div>
          <div class="col-md-3">
      ...
      <div class="row">
          <div class="col-md-3 field-label-responsive">
              <label for="email" name="keluhan">Keluhan</label>
          </div>
          <div class="col-md-6">
              <div class="form-group">
                  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                      <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-plus-circle" aria-hidden="true"></i></div>
                      <textarea rows="4" cols="50" name="keluhan" class="form-control" placeholder="Masukan Keluhan Anda" required autofocus></textarea>
                  </div>
              </div>
              <div class="row">
          <div class="col-md-3">

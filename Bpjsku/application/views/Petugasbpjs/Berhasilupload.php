...
<body>
  ...
  <div class="container-login100">
    ...
    <div style="padding-left:400px;" class="container">
    <form class="form-horizontal" role="form" method="POST" action="/register">
        <div class="row">
            <div class="col-md-6">
				<div class="juduldaftar">
                <h2 align="center">SUKSES</h2>
                <hr>
                <h6 align="center">Data anda sudah di upload</h6>
                <div class="row">
                    <div class="nomortiket1" style="margin-left:110px;">
                    <H5>BERHASIL UPLOAD</H5>
                    </div>
                </div>
         </div>
            </div>

...
<html lang="en">
<head>
    <title>Upload Laporan Cair</title>
...
<body>
  ...
  <div class="container-login100">
    ...
    <div class="container">
  <form class="form-horizontal" role="form" method="POST" action="<?php echo site_url('Uploadlaporandanacair/tambah_aksi') ?>" validate-form>
      <div class="row">
          <div class="col-md-2">
      <div class="logoCatalog">
      <img src="<?php echo base_url("assets/images/logo.png") ?>"width="150px" height="150px" alt="logoctlg">
      </div>
    </div>
          <div class="col-md-6">
    ...
    <div class="container">
<form class="form-horizontal" role="form" method="POST" action="Petugasbpjs/BerhasilUpload" onSubmit="return validasi()">
  <div class="row">
      <div class="col-md-3 field-label-responsive">
          <label for="tglupload">Tanggal Upload</label>
      </div>
      <div class="col-md-6">
          <div class="form-group">
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa fa-calendar"></i></div>
                  <input type="date" name="tanggalupload" class="form-control" id="name"
  ...
  <div class="row">
      <div class="col-md-3 field-label-responsive">
          <label for="waktu">Waktu Upload</label>
      </div>
      <div class="col-md-6">
          <div class="form-group">
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-clock-o"></i></div>
                  <input type="time" name="waktuupload" class="form-control" id="name"
      ...
      <div class="col-md-6">
          <div class="form-group has-danger">
              <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                  ...
                  <input type="subjek" name="subjek" class="form-control" id="password"
...
<br>
<p>Menu Lain :</p>
<input class="call-btn button gradient-bg" type="button" value="Laporan Administrasi" onclick="location.href='<?php echo site_url();?>/Home/laporanadministrasi'" />
</form>
</div>

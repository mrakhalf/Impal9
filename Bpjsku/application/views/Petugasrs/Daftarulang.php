...
<body>
  ...
  <div class="container-login100">
    ...
    <div class="col-md-6">
                ...
                <h2 align="center">DAFTAR ULANG</h2>
                <hr>
                </div>
            </div>

            <div class="container">
    <form class="form-horizontal" role="form" method="POST" action="InputSuratRujukan.html">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-3 field-label-responsive">
                <label for="name">ID BPJS</label>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-id-badge"></i></div>
                        <input type="text" name="name" class="form-control" id="name"
        ...
        <div class="row">
            <div class="col-md-3 field-label-responsive">
                <label for="name">Nomor Antian</label>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-sort-numeric-desc"></i></div>
                        <input type="text" name="name" class="form-control" id="name"

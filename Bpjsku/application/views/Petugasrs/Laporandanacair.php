...
<body>
                ...
                <div class="row">
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        <div class="site-branding d-flex align-items-center">
                           <a class="d-block" href="<?php echo site_url('Home/index'); ?>" rel="home"><img class="d-block" src="<?php echo base_url('assets/images/logo.png'); ?>" alt="logo"></a>
                        </div><!-- .site-branding -->
  ...
  <div class="container-login100">
    ...
    <div class="col-md-6">
                ...
                <h2 align="center">LAPORAN ADMINISTRASI DANA CAIR</h2>
                <hr>
				</div>
            </div>
